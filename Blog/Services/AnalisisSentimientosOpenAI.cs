...
public class AnalisisSentimientosOpenAI : IAnalisisSentimientos
{
    ...
    public AnalisisSentimientosOpenAI(
    ...
    /// <summary>
    /// Metodo que analiza los comentarios pendientes de análisis de sentimientos.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Construye una cadena con formato JSON que contiene un lote de solicitudes de análisis de sentimientos.
    /// </summary>
    /// <remarks>TEste método genera un lote de solicitudes para una API de análisis de sentimientos. Cada solicitud.
    /// Especifica el modelo a utilizar e incluye el texto del comentario que se analizará. La API espera una respuesta con un
    /// con una puntuación de entusiasmo de 1 a 5.</remarks>
    /// <param name="comentariosPendientesDeAnalisis"
    /// <returns>Una cadena con formato JSON donde cada línea representa una solicitud serializada de análisis de sentimiento. Cada solicitud
    /// incluye el identificador del comentario, el modelo de análisis y el contenido del mensaje..</returns>
    ...
    /// <summary>
    /// Archivo con las peticiones para subir a OpenAI
    /// </summary>
    ...
    /// <summary>
    /// Envia el lote a la base de datos y actualiza los comentarios
    /// </summary>
    /// <param name="comentariosPendientesDeAnalisis"></param>
    ...
    /// <summary>
    /// Verificamos los lotes pendientes y procesamos los resultados
    /// </summary>
    /// <returns></returns>
